...
describe('Electrons', function() {
	...
	it('should return -1 for array [3]', function() {
		expect(electrons.calculate([3])).toEqual(-1);
	});

	it('should return -1 for array [5]', function() {
		expect(electrons.calculate([5])).toEqual(-1);
	});

	it('should return -1 for array [1, 2]', function() {
		expect(electrons.calculate([1, 2])).toEqual(-1);
	});

	it('should return 2 for array [1, 2, 3, 4]', function() {
		expect(electrons.calculate([1, 2, 3, 4])).toEqual(2);
	});

	it('should return -2 for array [1, 2, 3, 4, 5, 6, 7]', function() {
		expect(electrons.calculate([1, 2, 3, 4, 5, 6, 7])).toEqual(-2);
	});
});
